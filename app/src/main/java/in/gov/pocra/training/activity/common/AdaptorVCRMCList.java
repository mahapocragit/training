package in.gov.pocra.training.activity.common;
...
public class AdaptorVCRMCList  extends RecyclerView.Adapter<AdaptorVCRMCList.ViewHolder> {
    ...
    public AdaptorVCRMCList(Context context, JSONArray jsonArray, String talukaID, OnMultiRecyclerItemClickListener listener) {
