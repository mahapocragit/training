...
public class AdaptorSessionDetailList extends RecyclerView.Adapter<AdaptorSessionDetailList.ViewHolder> {
    ...
    public AdaptorSessionDetailList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSessionDetailList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_session, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSessionDetailList.ViewHolder viewHolder, int i) {
