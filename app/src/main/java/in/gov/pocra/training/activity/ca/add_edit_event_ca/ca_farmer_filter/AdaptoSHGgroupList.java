...
public class AdaptoSHGgroupList extends RecyclerView.Adapter<AdaptoSHGgroupList.ViewHolder> {
    ...
    public AdaptoSHGgroupList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String villageActId, String villageActName) {
    ...
    @NonNull
    @Override
    public AdaptoSHGgroupList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_shg_group, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptoSHGgroupList.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            proNameTView = (TextView) itemView.findViewById(R.id.proNameTView);
            flagtxt = (TextView) itemView.findViewById(R.id.flagtxt);
        ...
        private void onBind(final JSONObject jsonObject, final int position, OnMultiRecyclerItemClickListener listener) {
            ...
            try {
                ...
                String proname = AppUtility.getInstance().sanitizeJSONObj(jsonObject, "chief_promoter_president");
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String sledFarmer = AppSettings.getInstance().getValue(mContext, ApConstants.kS_SHG_PARTICIPANTS_ARRAY, ApConstants.kS_SHG_PARTICIPANTS_ARRAY);
                        JSONArray sledFarArray = new JSONArray();
                        try {
                            if (!sledFarmer.equalsIgnoreCase("kS_SHG_PARTICIPANTS_ARRAY")) {
