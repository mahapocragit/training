...
public class PmuFarmerFilterActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    private void defaultConfiguration() {
        ...
        activityLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {

                    if (ActivityJsonArray != null) {
                        ApUtil.showCustomListPicker(activityTView, ActivityJsonArray, "Select Training Type", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
                        getListOfActivity();
                    }

                } else {
                    UIToastMessage.show(PmuFarmerFilterActivity.this, "No internet connection");
                }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (districtJsonArray != null) {
                        ApUtil.showCustomListPicker(districtTView, districtJsonArray, "Select District", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);

                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision")) {
                            getDistrictList();
                        } else {
                            UIToastMessage.show(PmuFarmerFilterActivity.this, "Please select location");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !districtId.equalsIgnoreCase("")) {
                            getSubDivisionList(districtId);
                        } else {
                            UIToastMessage.show(PmuFarmerFilterActivity.this, "Please select district");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
                            UIToastMessage.show(PmuFarmerFilterActivity.this, "Please select Sub-Division");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(PmuFarmerFilterActivity.this, "Please select Taluka");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (componentJsonArray != null) {
                        ApUtil.showCustomListPicker(componentTView, componentJsonArray, "Select Component Type", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (subComponentJsonArray != null) {
                        ApUtil.showCustomListPicker(subComponentTView, subComponentJsonArray, "Select sub-component Type", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (mainActivityJsonArray != null) {
                        ApUtil.showCustomListPicker(mainActivityTView, mainActivityJsonArray, "Select Main activity Type", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
        ...
        activityLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFarmerFilterActivity.this)) {
                    ...
                    if (ActivityJsonArray != null) {
                        ApUtil.showCustomListPicker(activityTView, ActivityJsonArray, "Select Activity Type", "name", "id", PmuFarmerFilterActivity.this, PmuFarmerFilterActivity.this);
                    } else {
    ...
    private void getSubDivisionList(String districtId) {
        ...
        Log.d("getSubDivisionList=","getSubDivisionList==="+subDivisionUrl);
        AppinventorIncAPI api = new AppinventorIncAPI(this, APIServices.API_URL, "", ApConstants.kMSG, true);
    ...
    private void getComponentAndActivityList(String id,int reqCode) {
        ...
        Log.d("MAYU111","ComponentAndActivityList=="+subTalukaUrl);
        AppinventorIncAPI api = new AppinventorIncAPI(this, APIServices.API_URL, "", ApConstants.kMSG, true);
    ...
    private void nextButtonAction() {
        ...
        if (districtId.equalsIgnoreCase("")) {
            ...
            Intent intent = new Intent(this, PmuFarmerListActivity.class);
            ...
            try {
                ...
                if (i == 3) {
                    ...
                    if (status.equalsIgnoreCase("200")) {
                        ...
                        Log.d("subDivisionJsonArray=","getSubDivisionList==="+subDivisionJsonArray);
