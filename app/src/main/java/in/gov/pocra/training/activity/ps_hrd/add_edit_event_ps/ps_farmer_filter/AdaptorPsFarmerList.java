...
public class AdaptorPsFarmerList extends RecyclerView.Adapter<AdaptorPsFarmerList.ViewHolder> {
    ...
    public AdaptorPsFarmerList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String villageActId, String villageActName) {
    ...
    @NonNull
    @Override
    public AdaptorPsFarmerList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_village_farmers, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorPsFarmerList.ViewHolder viewHolder, int i) {
