...
public class AdaptorDesignationCaMembersList extends RecyclerView.Adapter<AdaptorDesignationCaMembersList.ViewHolder> {
    ...
    public AdaptorDesignationCaMembersList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String userId) {
