...
import in.gov.pocra.training.activity.common.session_detail.EventDateActivity;
...
public class PmuUpcomingEventDetailActivity extends AppCompatActivity implements DatePickerCallbackListener, AlertListCallbackEventListener, ApiJSONObjCallback, ApiCallbackCode, OnMultiRecyclerItemClickListener {
    ...
    private JSONArray sessionDateArray = null;
    ...
    private ArrayList<String> toUpdateActivitySled = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ps_upcoming_event_detail_);
        ...
        sessionImage = (ImageView) getSupportActionBar().getCustomView().findViewById(R.id.addPersonImageView);
        sessionImage.setVisibility(View.VISIBLE);
        sessionImage.setImageDrawable(getResources().getDrawable(R.drawable.sesson_icon));
        sessionImage.setColorFilter(ContextCompat.getColor(this, R.color.white));
    ...
    private void initialization() {
        ...
        homeBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sessionImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        sessionImageAction();
                    }
        ...
        oVenueLocationTView = (TextView) findViewById(R.id.oVenueLocationTView);
        eventTitleEditText = (EditText) findViewById(R.id.eventTitleEditText);
...
//          selectFarmerLLayout.setEnabled(false);
    ...
    private void getDatesArray() {
        if (!eventStartDate.equalsIgnoreCase("") && !eventEndDate.equalsIgnoreCase("")) {
            String stDate = ApUtil.getDateByTimeStamp(eventStartTime);
            String edDate = ApUtil.getDateByTimeStamp(eventEndTime);
            sessionDateArray = ApUtil.getDateBetweenTwoDate(stDate, edDate);
        }
    }


    // to View Session
    private void sessionImageAction() {
        if (sessionDateArray != null && sessionData != null) {
            Intent intent = new Intent(this, EventDateActivity.class);
            intent.putExtra("sessionDateArray", sessionDateArray.toString());
            intent.putExtra("sessionDetail", sessionData.toString());
            startActivity(intent);
        } else {
            UIToastMessage.show(this, "No session data found");
        }
    }
    ...
    private void setSelectedGP() {
        ...
        Log.d("test123232sled",sledGPJSONArray.toString());
        if (sledGPJSONArray.length() > 0) {
            ...
            adaptorSelectedGP = new AdaptorSelectedGP(PmuUpcomingEventDetailActivity.this, sledGPJSONArray, actionType, PmuUpcomingEventDetailActivity.this, this);
    ...
    private void setSelectedFarmer() {
        ...
        if (sledFarmerJSONArray.length() > 0) {
            ...
            adaptorSelectedfarmer = new AdaptorSelectedFarmer(PmuUpcomingEventDetailActivity.this, sledFarmerJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
    ...
    private void setSelctSHGgroup() {
        ...
        if (sledSHGJSONArray != null && sledSHGJSONArray.length() > 0) {
            ...
            adaptorSelectedSGF = new AdaptorSelectedSGF(PmuUpcomingEventDetailActivity.this, sledSHGJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
    ...
    private void setSelctFPCgroup() {
        ...
        if (sledFPCJSONArray != null && sledFPCJSONArray.length() > 0) {
            ...
            adaptorSelectedFpc = new AdaptorSelectedFPC(PmuUpcomingEventDetailActivity.this, sledFPCJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
    ...
    private void setSelctFRgroup() {
        ...
        if (sledFRJSONArray != null && sledFRJSONArray.length() > 0) {
            ...
            adaptorSelectedFR = new AdaptorSelectedFR(PmuUpcomingEventDetailActivity.this, sledFRJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
    ...
    private void setSelectedFacilitator() {
        ...
        try {
            String sledPomParticipants = AppSettings.getInstance().getValue(this, ApConstants.kS_FACILITATOR_ARRAY, ApConstants.kS_FACILITATOR_ARRAY);
            if (!sledPomParticipants.equalsIgnoreCase("kS_FACILITATOR_ARRAY")) {
                sledPOMemberJSONArray = new JSONArray(sledPomParticipants);
                ...
                if (sledPOMemberJSONArray.length() > 0) {
                    ...
                    if (sledPOMemberJSONArray.length() > 0) {
                        ...
                        adaptorSelectedPOMember = new AdaptorSelectedPOMember(PmuUpcomingEventDetailActivity.this, sledPOMemberJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
        ...
        try {
            if (!sledOthParticipants.equalsIgnoreCase("kS_OTH_PARTICIPANTS_ARRAY")) {
                ...
                if (sledOthParticipantJSONArray.length() > 0) {
                    ...
                    adaptorSelectedOthParticipant = new AdaptorSelectedOthParticipants(PmuUpcomingEventDetailActivity.this, sledOthParticipantJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
        ...
        try {
            if (!sledCoordinator.equalsIgnoreCase("kS_COORDINATOR")) {
                ...
                if (sledCordJSONArray.length() > 0) {
                    ...
                    adaptorSelectedCoordinator = new AdaptorSelectedCoordinator(PmuUpcomingEventDetailActivity.this, sledCordJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
        ...
        try {
            ...
            if (!sledCoCoord.equalsIgnoreCase("kS_CO_COORDINATOR")) {
                ...
                if (sledCoCoordJSONArray.length() > 0) {
                    ...
                    adaptorSelectedCoCoord = new AdaptorSelectedCoCoord(PmuUpcomingEventDetailActivity.this, sledCoCoordJSONArray, actionType, PmuUpcomingEventDetailActivity.this);
    ...
    private void getNumberOfParticipant() {
        ...
        if (sledGPJSONArray != null) {
            Log.d("dhfhdfdfhdgd",sledGPJSONArray.toString());
...
Log.d("dhfhdfdfhdgd", String.valueOf(gpMemCount));
    ...
    private void defaultConfiguration() {
        ...
        sledVCRMCMoreTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PmuUpcomingEventDetailActivity.this, ParticipantGPListActivity.class);
        ...
        sledshgMoreTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sledSHGJSONArray = eDB.getShglist();
                Intent intent = new Intent(PmuUpcomingEventDetailActivity.this, ParticipantsListActivity.class);
        ...
        sledPOMMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledPomParticipants = AppSettings.getInstance().getValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, ApConstants.kS_FACILITATOR_ARRAY);
                if (!sledPomParticipants.equalsIgnoreCase("kS_FACILITATOR_ARRAY")) {
                    try {
                        sledPOMemberJSONArray = new JSONArray(sledPomParticipants);
                        // sledPOMemberJSONArray = eDB.getSledPOMemberList();
        ...
        selectCaResourceMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledResourceParticipants = AppSettings.getInstance().getValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_CA_RES_PERSON_ARRAY, ApConstants.kS_CA_RES_PERSON_ARRAY);
        ...
        sledOtherMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledOthParticipants = AppSettings.getInstance().getValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, ApConstants.kS_OTH_PARTICIPANTS_ARRAY);
    ...
    private void getScheduledEventBySchId(String Sch_id) {
        String eventLevel = getIntent().getStringExtra("event_level");
        eventLevel = "Pmu";
        String level = "";
        if (eventLevel.equalsIgnoreCase("Subdivision")) {
            level = eventLevel;
        } else {
            level = AppSettings.getInstance().getValue(this, ApConstants.kUSER_LEVEL, ApConstants.kUSER_LEVEL);
        }
        ...
        DebugLog.getInstance().d("pmu_event_detail_by_id_param=" + responseCall.request().toString());
        DebugLog.getInstance().d("pmu_event_detail_by_id_param=" + AppUtility.getInstance().bodyToString(responseCall.request()));

        api.postRequest(responseCall, this, 5);

       /* if (eventLevel.equalsIgnoreCase("s") || eventLevel.equalsIgnoreCase("Subdivision")){
            RequestBody requestBody = AppUtility.getInstance().getRequestBody(jsonObject.toString());
            AppinventorApi api = new AppinventorApi(this, APIServices.BASE_URL, "", ApConstants.kMSG, true);
            Retrofit retrofit = api.getRetrofitInstance();
            APIRequest apiRequest = retrofit.create(APIRequest.class);
...
*/
    ...
    private void setScheduledEventData(JSONArray eventJsonArray) {
        ...
        try {
            ...
            if (eventVenueId.equalsIgnoreCase("1") || eventVenueId.equalsIgnoreCase("64")) {
                ...
                oVenueLocationTView.setText(eventOtherVenue);
            ...
            if (gpArray != null && gpArray.length() > 0) {
                ...
                for (int ri = 0; ri < gpArray.length(); ri++) {
                    ...
                    String taluka_Id = gpJosn.getString("taluka_id");

                    if (inTaluka_Id.equalsIgnoreCase("")) {

                        if (!eDB.isTalukaPresentById(taluka_Id)) {

                            talukaId = taluka_Id;

                            inTaluka_Id = taluka_Id;
                        ...
                        if (!inTaluka_Id.equalsIgnoreCase(taluka_Id)) {
    ...
    private void clearInputFields() {
        ...
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_GP_ARRAY, ApConstants.kS_GP_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FARMER_ARRAY, ApConstants.kS_FARMER_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, ApConstants.kS_FACILITATOR_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_CA_RES_PERSON_ARRAY, ApConstants.kS_CA_RES_PERSON_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, ApConstants.kS_OTH_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_RES_PERSON, ApConstants.kS_RES_PERSON);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_COORDINATOR, ApConstants.kS_COORDINATOR);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_CO_COORDINATOR, ApConstants.kS_CO_COORDINATOR);
        //AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_EVENT_S_DATE, ApConstants.kS_EVENT_S_DATE);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_EVENT_E_DATE, ApConstants.kS_EVENT_E_DATE);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_SHG_PARTICIPANTS_ARRAY, ApConstants.kS_SHG_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FPC_PARTICIPANTS_ARRAY, ApConstants.kS_FPC_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_farm_PARTICIPANTS_ARRAY, ApConstants.kS_farm_PARTICIPANTS_ARRAY);
        eDB.deleteAllData();
    }
        ...
        try {
            ...
            if (i == 1) {
                ...
                if (sledGPJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_GP_ARRAY, sledGPJSONArray.toString());
                    sledGPId = AppUtility.getInstance().componentSeparatedByCommaJSONArray(sledGPJSONArray, "gp_id");
                ...
                if (sledFarmerJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FARMER_ARRAY, sledFarmerJSONArray.toString());
                ...
                if (sledCoCoordJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_CO_COORDINATOR, sledCoCoordJSONArray.toString());
                ...
                if (sledCordJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_COORDINATOR, sledCordJSONArray.toString());
                ...
                if (sledPOMemberJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, sledPOMemberJSONArray.toString());
                ...
                if (sledOthParticipantJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PmuUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, sledOthParticipantJSONArray.toString());
                ...
                /*if (sledPOMemberJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(AddEventPmuActivity.this, ApConstants.kS_P_FIELD_STAFF_ARRAY, sledPOMemberJSONArray.toString());
            ...
            if (jsonObject != null) {
                ...
                if (i == 6) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        try {
                            nJson.put("ca_id", talukaId);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

                        RequestBody requestBody = AppUtility.getInstance().getRequestBody(nJson.toString());
                        AppinventorApi api = new AppinventorApi(this, APIServices.API_URL, "", ApConstants.kMSG, true);
                        Retrofit retrofit = api.getRetrofitInstance();
                        APIRequest apiRequest = retrofit.create(APIRequest.class);
                        ...
                        api.postRequest(responseCall, this, 61);
                    }
                }


                // Set GP detail Response
                if (i == 61) {
