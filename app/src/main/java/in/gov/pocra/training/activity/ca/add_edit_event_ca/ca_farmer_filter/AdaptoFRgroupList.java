...
public class AdaptoFRgroupList extends RecyclerView.Adapter<AdaptoFRgroupList.ViewHolder> {
    ...
    public AdaptoFRgroupList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String villageActId, String villageActName) {
    ...
    @NonNull
    @Override
    public AdaptoFRgroupList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_shg_group, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptoFRgroupList.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void onBind(final JSONObject jsonObject, final int position, OnMultiRecyclerItemClickListener listener) {
            ...
            try {
                ...
                String farmerName = AppUtility.getInstance().sanitizeJSONObj(jsonObject, "group_name");
                String fMobile = AppUtility.getInstance().sanitizeJSONObj(jsonObject, "contact_number");
                ...
                detailIView.setOnClickListener(v -> {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String sledFarmer = AppSettings.getInstance().getValue(mContext, ApConstants.kS_farm_PARTICIPANTS_ARRAY, ApConstants.kS_farm_PARTICIPANTS_ARRAY);
                        JSONArray sledFarArray = new JSONArray();
                        try {
                            if (!sledFarmer.equalsIgnoreCase("kS_farm_PARTICIPANTS_ARRAY")) {
        ...
        private void updateSelection(int position,JSONArray selectedGPArray, String farId) {
            try {
                ...
                String fName = jsonObject.getString("group_name");
