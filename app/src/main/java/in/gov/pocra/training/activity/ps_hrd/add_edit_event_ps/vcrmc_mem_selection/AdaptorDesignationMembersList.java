...
public class AdaptorDesignationMembersList extends RecyclerView.Adapter<AdaptorDesignationMembersList.ViewHolder> {
    ...
    public AdaptorDesignationMembersList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String talukaID) {
    ...
    @NonNull
    @Override
    public AdaptorDesignationMembersList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new AdaptorDesignationMembersList.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorDesignationMembersList.ViewHolder viewHolder, int i) {

        try {
            // String grampanchayat = (String) mJSONArray.getJSONObject(i).get("name");
            // viewHolder.onBind(mJSONArray.getJSONObject(i).getJSONArray("vcrmc_member"), i, mListener, grampanchayat);
