...
public class AdaptorGPList extends RecyclerView.Adapter<AdaptorGPList.ViewHolder> {
    ...
    public AdaptorGPList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorGPList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_gp, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorGPList.ViewHolder viewHolder, int i) {
