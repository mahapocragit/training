...
public class FPCgrFarmerCaActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    private void defaultConfiguration() {
        ...
        subDivisionLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subDivisionJsonArray != null) {
                    ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "subdivision_name", "subdivision_id", FPCgrFarmerCaActivity.this, FPCgrFarmerCaActivity.this);
                } else {
        ...
        talukaLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(FPCgrFarmerCaActivity.this)) {

                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", FPCgrFarmerCaActivity.this, FPCgrFarmerCaActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
//                            UIToastMessage.show(FPCgrFarmerCaActivity.this, "Please select Sub-Division");
                            Toast.makeText(getBaseContext(), " Please select Sub-Division ", Toast.LENGTH_SHORT).show();
                        }
                    }

                } else {
//                    UIToastMessage.show(FPCgrFarmerCaActivity.this, "No internet connection");
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(FPCgrFarmerCaActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", FPCgrFarmerCaActivity.this, FPCgrFarmerCaActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(FPCgrFarmerCaActivity.this, "Please select Taluka");
                        }
                    }
...
//            UIToastMessage.show(this, "Select Subdivision");
            Toast.makeText(getBaseContext(), " Select Sub-Division", Toast.LENGTH_SHORT).show();
