...
public class AdaptorSelectedPOMember extends RecyclerView.Adapter<AdaptorSelectedPOMember.ViewHolder> {
    ...
    public AdaptorSelectedPOMember(Context context, JSONArray jsonArray, String actType, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSelectedPOMember.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_selected, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSelectedPOMember.ViewHolder viewHolder, int i) {
            ...
            if (mActType.equalsIgnoreCase("create")){
                cancelImageView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mListener.onMultiRecyclerViewItemClick(5, jsonObject);
