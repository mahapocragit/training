...
public class CaComingEventActivity extends AppCompatActivity implements ApiCallbackCode, OnMultiRecyclerItemClickListener {

    private ImageView homeBack;
    private ImageView addPersonImageView;

    private String eventType;
    private RecyclerView caComingEventRView;
    ...
    private AdaptorCaComingEvent adaptorCaComingEvent;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ca_coming_event);
        ...
        addPersonImageView.setImageDrawable(getResources().getDrawable(R.drawable.ic_more));
    ...
    private void initialization() {
        ...
        caComingEventRView = (RecyclerView) findViewById(R.id.caComingEventRView);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        caComingEventRView.setLayoutManager(linearLayoutManager);
    ...
    protected void onResume() {
        ...
        if (eventType.equalsIgnoreCase("kS_SELF_EVENT")) {
            ...
            if (!distId.equalsIgnoreCase("")){
                getScheduledEventListByDistId(distId,subDivId);
            }else {
    ...
    private void defaultConfiguration() {
        ...
        searchEText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                CaComingEventActivity.this.adaptorCaComingEvent.filter(s.toString());
            }
        });
    ...
    private void getScheduledEventListByDistId(String distId, String subDivisionId) {

        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("level", "Subdivision");
            jsonObject.put("user_id", userID);
            jsonObject.put("role_id", roleId);
            ...
            if (jsonObject != null) {
                ...
                if (i == 1) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        adaptorCaComingEvent = new AdaptorCaComingEvent(this, scheduleJSONArray, true, this);
                        caComingEventRView.setAdapter(adaptorCaComingEvent);
                    } else {
                ...
                if (i == 2) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        adaptorCaComingEvent = new AdaptorCaComingEvent(this, eventByDistJSONArray, false, this);
                        caComingEventRView.setAdapter(adaptorCaComingEvent);
                    } else {
                        UIToastMessage.show(this, responseModel.getMsg());
                    }
                ...
                if (i == 3) {
                    ...
                    if (eventCancelRModel.isStatus()) {
                        ...
                        Toast.makeText(this, ""+eventCancelRModel.getMsg(), Toast.LENGTH_SHORT).show();
                        getScheduleList();
                    } else {
                       // UIToastMessage.show(this, eventCancelRModel.getMsg());
                        Toast.makeText(this, ""+eventCancelRModel.getMsg(), Toast.LENGTH_SHORT).show();
