...
public class AdaptorSelectedOthParticipants extends RecyclerView.Adapter<AdaptorSelectedOthParticipants.ViewHolder> {
    ...
    public AdaptorSelectedOthParticipants(Context context, JSONArray jsonArray, String actType, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSelectedOthParticipants.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_selected, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSelectedOthParticipants.ViewHolder viewHolder, int i) {
