...
public class AdaptorCaComingEvent extends RecyclerView.Adapter<AdaptorCaComingEvent.ViewHolder> {
    ...
    public AdaptorCaComingEvent(Context context, JSONArray jsonArray, boolean optionToShow, OnMultiRecyclerItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_ca_coming_event, viewGroup, false);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Intent intent = new Intent(mContext, CaUpcomingEventDetailActivity.class);
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        if (is_sch_closed.equalsIgnoreCase("0")){
                            ...
                            // To reschedule current date event Added by santosh
                                ...
                                public boolean onMenuItemClick(MenuItem item) {
                                    switch (item.getItemId()) {
                                        case R.id.action_update:
                                            Intent intent = new Intent(mContext, AddEditEventCaActivity.class);
                                            intent.putExtra("type", "update");
                                            intent.putExtra("sch_id", sch_id);
                                            mContext.startActivity(intent);
                                            break;
