...
import in.gov.pocra.training.activity.pmu.pmu_upcoming_event.PmuUpcomingEventDetailActivity;
import in.gov.pocra.training.activity.ps_hrd.ps_report.EventReportActivity;
import in.gov.pocra.training.util.ApUtil;

public class AdaptorPmuClosedEvent extends RecyclerView.Adapter<AdaptorPmuClosedEvent.ViewHolder> {
    ...
    public AdaptorPmuClosedEvent(Context context, JSONArray jsonArray, String level) {
    ...
    @NonNull
    @Override
    public AdaptorPmuClosedEvent.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_closed_event, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptorPmuClosedEvent.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(final JSONObject jsonObject, int i) {
            ...
            try {
                ...
                String clDateTime = "";
                if (closingTime != null){
                    clDateTime = ApUtil.getDateTimeByTimeStamp(closingTime);
                }
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    ...
                                    case R.id.action_detail:
                                        Intent eIntent = new Intent(mContext, PmuUpcomingEventDetailActivity.class);
                                        eIntent.putExtra("event_level", mLevel);
