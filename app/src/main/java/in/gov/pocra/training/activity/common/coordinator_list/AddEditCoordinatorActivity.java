...
public class AddEditCoordinatorActivity extends AppCompatActivity implements AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_edit_coordinator);
        ...
        actionTitleTextView.setText(getResources().getString(R.string.title_add_edit_coordinator));
...
//        schId = getIntent().getStringExtra("schId");
    ...
    private void setMemberDetail(String membDetail) {
        ...
        try {
            ...
            if (jsonObject.length() > 0) {
                ...
                socCatTextView.setText(socialCategory);
    ...
    private void updateButtonAction() {
        ...
        if (fName.isEmpty()) {
            ...
            // UIToastMessage.show(this,"Registration Validation success");
