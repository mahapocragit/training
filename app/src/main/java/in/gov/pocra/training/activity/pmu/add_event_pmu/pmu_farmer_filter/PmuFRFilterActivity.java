...
public class PmuFRFilterActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    private void defaultConfiguration() {
        ...
        districtLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFRFilterActivity.this)) {

                    if (districtJsonArray != null) {
                        ApUtil.showCustomListPicker(districtTView, districtJsonArray, "Select District", "name", "id", PmuFRFilterActivity.this, PmuFRFilterActivity.this);

                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision")) {
                            getDistrictList();
                        } else {
                            UIToastMessage.show(PmuFRFilterActivity.this, "Please select location");
                        }
                    }

                } else {
                    UIToastMessage.show(PmuFRFilterActivity.this, "No internet connection");
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFRFilterActivity.this)) {
                    ...
                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PmuFRFilterActivity.this, PmuFRFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !districtId.equalsIgnoreCase("")) {
                            getSubDivisionList(districtId);
                        } else {
                            UIToastMessage.show(PmuFRFilterActivity.this, "Please select district");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFRFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PmuFRFilterActivity.this, PmuFRFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
                            UIToastMessage.show(PmuFRFilterActivity.this, "Please select Sub-Division");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFRFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", PmuFRFilterActivity.this, PmuFRFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(PmuFRFilterActivity.this, "Please select Taluka");
                        }
                    }
