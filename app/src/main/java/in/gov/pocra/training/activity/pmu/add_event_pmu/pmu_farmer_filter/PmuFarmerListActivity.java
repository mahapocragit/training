...
public class PmuFarmerListActivity extends AppCompatActivity implements ApiCallbackCode, OnMultiRecyclerItemClickListener {
    ...
    private AdaptorPmuFarmerList adaptorPmuFarmerList;
        ...
        checkAllTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (farmerWithSelected != null) {
                    ...
                    UIToastMessage.show(PmuFarmerListActivity.this, "No member for selection");
                }
            }
        });
    ...
    private void confirmButtonAction() {
        ...
        try {
            ...
            if (adaptorPmuFarmerList != null) {

                for (int i = 0; i < adaptorPmuFarmerList.mJSONArray.length(); i++) {
                    JSONObject jsonObject = adaptorPmuFarmerList.mJSONArray.getJSONObject(i);

                    if (jsonObject.getInt("is_selected") == 1) {
                        if (sledFarmerJSONArray.length() < 101) {
                            sledFarmerJSONArray.put(jsonObject);
                        } else {
                            UIToastMessage.show(PmuFarmerListActivity.this, "More than 100 farmer not allowed");
                            break;
                        }
                    }
                }
                ...
                if (sledFarmerJSONArray.length() > 0) {
                    AppSettings.getInstance().setValue(PmuFarmerListActivity.this, ApConstants.kS_FARMER_ARRAY, sledFarmerJSONArray.toString());
                    AppSettings.getInstance().setValue(PmuFarmerListActivity.this, ApConstants.kS_COORDINATOR, ApConstants.kS_COORDINATOR);
                    finish();
                } else {
                    UIToastMessage.show(PmuFarmerListActivity.this, "Select at least one farmer");
                }
                ...
                if (i == 1) {
                    ...
                    if (fLModel.isStatus()){
                        ...
                        if (farmerJSONArray.length() > 0){
                            ...
                            adaptorPmuFarmerList = new AdaptorPmuFarmerList(this,farmerWithSelected,this, activityId, activityName);
                            farmerRView.setAdapter(adaptorPmuFarmerList);
