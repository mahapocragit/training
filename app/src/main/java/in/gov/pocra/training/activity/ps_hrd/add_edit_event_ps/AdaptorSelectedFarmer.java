...
public class AdaptorSelectedFarmer extends RecyclerView.Adapter<AdaptorSelectedFarmer.ViewHolder> {
    ...
    public AdaptorSelectedFarmer(Context context, JSONArray jsonArray, String actType,OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSelectedFarmer.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_selected, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSelectedFarmer.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void onBind(final JSONObject jsonObject, final int position, OnMultiRecyclerItemClickListener listener) {
            ...
            try {
                ...
                final String villageId = jsonObject.getString("village_id");
                final String villageName = jsonObject.getString("village_name");
