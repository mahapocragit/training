...
import in.gov.pocra.training.activity.ca.add_edit_event_ca.ca_farmer_filter.CaFPCFarmerGroupListActivity;
...
public class PmuFPCFilterActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionTitleTextView.setText("FPC Group");
    ...
    private void initialization() {
        ...
        nextButton.setText("Click for FPC List");
    }
    ...
    private void defaultConfiguration() {
        ...
        districtLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFPCFilterActivity.this)) {

                    if (districtJsonArray != null) {
                        ApUtil.showCustomListPicker(districtTView, districtJsonArray, "Select District", "name", "id", PmuFPCFilterActivity.this, PmuFPCFilterActivity.this);

                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision")) {
                            getDistrictList();
                        } else {
                            UIToastMessage.show(PmuFPCFilterActivity.this, "Please select location");
                        }
                    }

                } else {
                    UIToastMessage.show(PmuFPCFilterActivity.this, "No internet connection");
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFPCFilterActivity.this)) {
                    ...
                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PmuFPCFilterActivity.this, PmuFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !districtId.equalsIgnoreCase("")) {
                            getSubDivisionList(districtId);
                        } else {
                            UIToastMessage.show(PmuFPCFilterActivity.this, "Please select district");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFPCFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PmuFPCFilterActivity.this, PmuFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
                            UIToastMessage.show(PmuFPCFilterActivity.this, "Please select Sub-Division");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PmuFPCFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", PmuFPCFilterActivity.this, PmuFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(PmuFPCFilterActivity.this, "Please select Taluka");
                        }
                    }
    ...
    private void nextButtonAction() {
        ...
        if (districtId.equalsIgnoreCase("")) {
            ...
            Intent intent = new Intent(this, CaFPCFarmerGroupListActivity.class);
