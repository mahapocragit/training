...
public class AdaptorCaFarmerList extends RecyclerView.Adapter<AdaptorCaFarmerList.ViewHolder> {
    ...
    public AdaptorCaFarmerList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener, String villageActId, String villageActName) {
    ...
    @NonNull
    @Override
    public AdaptorCaFarmerList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_village_farmers, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorCaFarmerList.ViewHolder viewHolder, int i) {
