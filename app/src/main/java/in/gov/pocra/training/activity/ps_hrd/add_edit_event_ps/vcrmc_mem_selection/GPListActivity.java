...
public class GPListActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, ApiCallbackCode {
    ...
    private AdaptorGPList adaptorGPList = null;
    ...
    private AdaptorVCRMCList adaptorVCRMCList = null;
    ...
    private void getGPListFromDB() {
        ...
        JSONArray gPArray = eDB.getGpList(talukaID);
        if (gPArray.length() > 0) {
            //to do designation
            adaptorGPList = new AdaptorGPList(GPListActivity.this, gPArray, GPListActivity.this);
            gpRecyclerView.setAdapter(adaptorGPList);
        } else {
                ...
                if (i == 1) {
                    ...
                    if (eventListRMode.isStatus()) {
                        ...
                        if (designationJSONArray.length() > 0) {
                            //to do designation
                            adaptorVCRMCList = new AdaptorVCRMCList(GPListActivity.this, designationJSONArray, talukaID, GPListActivity.this);
                            gpRecyclerView.setAdapter(adaptorVCRMCList);
                        } else {
                            adaptorVCRMCList = new AdaptorVCRMCList(GPListActivity.this, new JSONArray(), talukaID, GPListActivity.this);
                            gpRecyclerView.setAdapter(adaptorVCRMCList);
                            UIToastMessage.show(this, "NO VCRMC (GP) member found");
                        }
                    }
