...
import in.gov.pocra.training.activity.ca.ca_upcoming_event.AdaptorCaComingEvent;
...
public class CaEventCaleActivity extends AppCompatActivity implements OnDateSelectedListener, ApiCallbackCode, OnMultiRecyclerItemClickListener {
    //
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ca_event_cale);
            ...
            if (jsonObject != null) {
                ...
                if (i == 2) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        AdaptorCaComingEvent adaptorCaComingEvent = new AdaptorCaComingEvent(this,scheduleJSONArray, false, this);
                        eCalenderRView.setAdapter(adaptorCaComingEvent);
setDateToCalenderFromresponse(scheduleJSONArray);
                    } else {
                        AdaptorCaComingEvent adaptorCaComingEvent = new AdaptorCaComingEvent(this,null, false,this);
                        eCalenderRView.setAdapter(adaptorCaComingEvent);
                        UIToastMessage.show(this, responseModel.getMsg());
                    }
                }
