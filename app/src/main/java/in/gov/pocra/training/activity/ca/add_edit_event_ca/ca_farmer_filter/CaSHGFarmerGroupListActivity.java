...
public class CaSHGFarmerGroupListActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, ApiCallbackCode {
    // ApiCallbackCode,
    ...
    private AdaptoSHGgroupList adaptoSHGgroupList;
    String talukaId;
        ...
        checkAllTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (SHGWithSelected != null) {
                    ...
                    try {
                        ...
                        if (!allSelected) {
                            for (int i = 0; i < SHGWithSelected.length(); i++) {
                                ...
                                eDB.updateShgIsSelected(farId,"1");
                            }
                            ...
                            for (int i = 0; i < SHGWithSelected.length(); i++) {
                                JSONObject memJSONObkject = SHGWithSelected.getJSONObject(i);
                                String farId = memJSONObkject.getString("id");
                                eDB.updateShgIsSelected(farId,"0");
                            }
                            allSelected = false;
                    ...
                    Toast.makeText(CaSHGFarmerGroupListActivity.this, "No member for selection", Toast.LENGTH_SHORT).show();
//                    UIToastMessage.show(CaSHGFarmerGroupListActivity.this, "No member for selection");
                }
            }
        });
    ...
    protected void onResume() {
        ...
        String sledFarmers = AppSettings.getInstance().getValue(this, ApConstants.kS_SHG_PARTICIPANTS_ARRAY, ApConstants.kS_SHG_PARTICIPANTS_ARRAY);
        try {
            if (!sledFarmers.equalsIgnoreCase("kS_SHG_PARTICIPANTS_ARRAY")) {
    ...
    private void confirmButtonAction() {
        ...
        try {
            ...
            if (adaptoSHGgroupList != null) {

                for (int i = 0; i < adaptoSHGgroupList.mJSONArray.length(); i++) {
                    JSONObject jsonObject = adaptoSHGgroupList.mJSONArray.getJSONObject(i);
...
//                            UIToastMessage.show(CaSHGFarmerGroupListActivity.this, "More than 100 farmer not allowed");
                            break;
                        }
                    }
                }
                ...
                if (sledSHGJSONArray.length() > 0) {
                        ...
                        AppSettings.getInstance().setValue(CaSHGFarmerGroupListActivity.this, ApConstants.kS_SHG_PARTICIPANTS_ARRAY, sledSHGJSONArray.toString());
                        finish();
                } else {
                    Toast.makeText(this, "Select at least one farmer", Toast.LENGTH_SHORT).show();
//                    UIToastMessage.show(CaSHGFarmerGroupListActivity.this, "Select at least one farmer");
                }
            }
    ...
    public void onMultiRecyclerViewItemClick(int i, Object o) {
        ...
        try {
            ...
            if (sledSHGJSONArray != null) {
                ...
                AppSettings.getInstance().setValue(CaSHGFarmerGroupListActivity.this, ApConstants.kS_FARMER_ARRAY, sledSHGJSONArray.toString());
    ...
    // To get village array with selected farmers
    ...
    private void getSHGgrouplist() {
        ...
        Call<JsonObject> responseCall = apiRequest.GETSHG_LIST(requestBody);
                ...
                if (i == 1) {
                    ...
                    if (fLModel.isStatus()) {
                        ...
                        if (SHGJSONArray.length() > 0) {
                            ...
                            adaptoSHGgroupList = new AdaptoSHGgroupList(this, SHGWithSelected, this, activityId, activityName);
                            farmerRView.setAdapter(adaptoSHGgroupList);
