...
public class  SessionActivity extends AppCompatActivity implements ApiCallbackCode, OnMultiRecyclerItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSessionIView.setVisibility(View.VISIBLE);
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            RequestBody requestBody = AppUtility.getInstance().getRequestBody(param.toString());
                            AppinventorApi api = new AppinventorApi(SessionActivity.this, APIServices.BASE_URL, "", ApConstants.kMSG, true);
                            Retrofit retrofit = api.getRetrofitInstance();
                            APIRequest apiRequest = retrofit.create(APIRequest.class);
                            ...
                            api.postRequest(responseCall, SessionActivity.this, 2);
                ...
                if (i == 1) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        if (dataArray.length()>0){
                            AdaptorSessionList adaptorSessionList = new AdaptorSessionList(this,dataArray,this);
                            sessionRView.setAdapter(adaptorSessionList);
                        }else {
                            AdaptorSessionList adaptorSessionList = new AdaptorSessionList(this,new JSONArray(),this);
                            sessionRView.setAdapter(adaptorSessionList);
                        }
