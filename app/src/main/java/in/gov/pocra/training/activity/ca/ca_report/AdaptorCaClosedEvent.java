...
public class AdaptorCaClosedEvent extends RecyclerView.Adapter<AdaptorCaClosedEvent.ViewHolder> {
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                switch (item.getItemId()) {
                                    ...
                                    case R.id.action_consi:
                                        Intent cIntent = new Intent(mContext, CaEventReportActivity.class);
                                    ...
                                    case R.id.action_detail:
                                        Intent eIntent = new Intent(mContext, CaUpcomingEventDetailActivity.class);
