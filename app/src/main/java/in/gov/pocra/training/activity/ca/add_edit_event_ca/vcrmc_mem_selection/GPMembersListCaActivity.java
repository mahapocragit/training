...
public class GPMembersListCaActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, ApiCallbackCode {
    ...
    private AdaptorCaGPMembersList adaptorCaGPMembersList;
    private Button confirmButton;
    private String userID;
    private AdaptorDesignationCaMembersList adaptorDesignationCaMembersList;
    private String typeOfList;
    private AdaptorCaVCRMCList adaptorCaVCRMCList;
    ...
    protected void onResume() {
        ...
        if (typeOfList.equals("VCRMC")) {
            ...
            searchEText.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    GPMembersListCaActivity.this.adaptorCaGPMembersList.filter(s.toString());
        ...
        if (typeOfList.equals("designation")) {
            ...
            searchEText.addTextChangedListener(new TextWatcher() {
                ...
                @Override
                public void afterTextChanged(Editable s) {
                    GPMembersListCaActivity.this.adaptorDesignationCaMembersList.filter(s.toString());
    ...
    private void getDesignationMember() {
        gpMemArray =  eDB.getGpMemberListBydesignationId(gpId,userID);
...
//                            confirmButton.setText("Cancel");
    ...
    private void getGpMemberDetail() {
        ...
        adaptorCaGPMembersList = new AdaptorCaGPMembersList(GPMembersListCaActivity.this, gpMemArray, GPMembersListCaActivity.this);
        gpMemRecyclerView.setAdapter(adaptorCaGPMembersList);
    ...
    public void onMultiRecyclerViewItemClick(int i, Object o) {
        if(i ==2){
            ...
            JSONArray adaptArray = adaptorCaGPMembersList.mJSONArray;
    ...
    private void insertIntoGpTable(JSONArray gpJSONArray) {
        ...
        try {
            ...
            JSONArray memJSONArray =  eDB.getGpMemberListBydesignationId(gpId,userID);
            adaptorDesignationCaMembersList = new AdaptorDesignationCaMembersList(GPMembersListCaActivity.this, memJSONArray, GPMembersListCaActivity.this,userID);
            gpMemRecyclerView.setAdapter(adaptorDesignationCaMembersList);
            ...
            if (jsonObject != null) {
                ...
                if (i == 1) {
                    ...
                    if (eventListRMode.isStatus()) {
                        ...
                        if (typeOfList.equals("VCRMC")) {
                            adaptorCaVCRMCList = new AdaptorCaVCRMCList(GPMembersListCaActivity.this, designationJSONArray, userID, GPMembersListCaActivity.this);
                            gpMemRecyclerView.setAdapter(adaptorCaVCRMCList);
                        }
                    } else {
