...
public class AdaptorPsReportSessionList extends RecyclerView.Adapter<AdaptorPsReportSessionList.ViewHolder> {
    private Context mcontext;
    private JSONArray mJSONArray;
    private OnMultiRecyclerItemClickListener mListener;
    private int count = 0;

    public AdaptorPsReportSessionList(Context context, JSONArray mJSONArray, OnMultiRecyclerItemClickListener mListener) {
    ...
    @NonNull
    @Override
    public AdaptorPsReportSessionList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_report_ps_session, viewGroup, false);
        return new AdaptorPsReportSessionList.ViewHolder(view);
    }



    @Override
    public void onBindViewHolder(@NonNull AdaptorPsReportSessionList.ViewHolder viewHolder, int i) {
        try {
