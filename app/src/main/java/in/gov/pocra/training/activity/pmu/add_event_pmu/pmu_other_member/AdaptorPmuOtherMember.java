...
public class AdaptorPmuOtherMember extends RecyclerView.Adapter<AdaptorPmuOtherMember.ViewHolder> {
    ...
    public AdaptorPmuOtherMember(Context context, JSONArray jsonArray, String attendType, String vcrmcId, String schId) {
    ...
    @NonNull
    @Override
    public AdaptorPmuOtherMember.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_pmu_other_member, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptorPmuOtherMember.ViewHolder viewHolder, int i) {
