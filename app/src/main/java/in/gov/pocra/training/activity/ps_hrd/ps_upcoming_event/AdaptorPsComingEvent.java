...
public class AdaptorPsComingEvent extends RecyclerView.Adapter<AdaptorPsComingEvent.ViewHolder> {
    ...
    public AdaptorPsComingEvent(Context context, JSONArray jsonArray, boolean optionToShow, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorPsComingEvent.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_ps_coming_event, viewGroup, false);
        return new ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull AdaptorPsComingEvent.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(final JSONObject jsonObject, final int i) {
            ...
            try {
                ...
                /*int sTimeStamp = Integer.valueOf(sTime);
                int eTimeStamp = Integer.valueOf(eTime);
                String curDateTime = ApUtil.getCurrentTimeStamp();
                int cTimeStamp = Integer.valueOf(curDateTime);

                if (cTimeStamp >= sTimeStamp && cTimeStamp <= eTimeStamp){
                    optMoreImageView.setVisibility(View.GONE);
                }else {
                    optMoreImageView.setVisibility(View.VISIBLE);
                }*/
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        String level = AppSettings.getInstance().getValue(mContext, ApConstants.kUSER_LEVEL, ApConstants.kUSER_LEVEL);
                                    ...
                                    public boolean onMenuItemClick(MenuItem item) {
                                        switch (item.getItemId()) {
                                            case R.id.action_update:
                                                Intent intent = new Intent(mContext, AddEditEventPsHrdActivity.class);
                                                intent.putExtra("type", "update");
                                                intent.putExtra("sch_id", sch_id);
                                                mContext.startActivity(intent);
                                                break;
    ...
    private void askUserPermission(final JSONObject eJSONObject) {
        ...
        alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                /*Intent intent = new Intent(mContext, CancelEventPsActivity.class);
                intent.putExtra("sch_id", sch_id);
