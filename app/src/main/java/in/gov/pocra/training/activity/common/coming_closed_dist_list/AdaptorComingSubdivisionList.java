...
public class AdaptorComingSubdivisionList extends RecyclerView.Adapter<AdaptorComingSubdivisionList.ViewHolder> {

    private Context mContext;
    public JSONArray mJSONArray;
    private OnMultiRecyclerItemClickListener mListener;

    public AdaptorComingSubdivisionList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorComingSubdivisionList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_coming_district, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorComingSubdivisionList.ViewHolder viewHolder, int i) {
