...
public class PsHrdFPCFilterActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    private void defaultConfiguration() {
        ...
        subDivisionLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFPCFilterActivity.this)) {

                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PsHrdFPCFilterActivity.this, PsHrdFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !districtId.equalsIgnoreCase("")) {
                            getSubDivisionList(districtId);
                        } else {
                            UIToastMessage.show(PsHrdFPCFilterActivity.this, "Please select district");
                        }
                    }

                } else {
                    UIToastMessage.show(PsHrdFPCFilterActivity.this, "No internet connection");
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFPCFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PsHrdFPCFilterActivity.this, PsHrdFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
                            UIToastMessage.show(PsHrdFPCFilterActivity.this, "Please select Sub-Division");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFPCFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", PsHrdFPCFilterActivity.this, PsHrdFPCFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(PsHrdFPCFilterActivity.this, "Please select Taluka");
                        }
                    }
