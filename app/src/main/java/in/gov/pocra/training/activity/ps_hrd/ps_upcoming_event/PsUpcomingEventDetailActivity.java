...
public class PsUpcomingEventDetailActivity extends AppCompatActivity implements DatePickerCallbackListener, AlertListCallbackEventListener, ApiJSONObjCallback, ApiCallbackCode, OnMultiRecyclerItemClickListener {
...
//          selectFarmerLLayout.setEnabled(false);
    ...
    private void setSelectedGP() {
        ...
        if (sledGPJSONArray.length() > 0) {
            ...
            adaptorSelectedGP = new AdaptorSelectedGP(PsUpcomingEventDetailActivity.this, sledGPJSONArray, actionType, PsUpcomingEventDetailActivity.this, this);
    ...
    private void setSelectedFarmer() {
        ...
        if (sledFarmerJSONArray.length() > 0) {
            ...
            adaptorSelectedfarmer = new AdaptorSelectedFarmer(PsUpcomingEventDetailActivity.this, sledFarmerJSONArray, actionType, PsUpcomingEventDetailActivity.this);
    ...
    private void setSelctSHGgroup() {
        ...
        if (sledSHGJSONArray != null && sledSHGJSONArray.length() > 0) {
            ...
            adaptorSelectedSGF = new AdaptorSelectedSGF(PsUpcomingEventDetailActivity.this, sledSHGJSONArray, actionType, PsUpcomingEventDetailActivity.this);
    ...
    private void setSelctFPCgroup() {
        ...
        if (sledFPCJSONArray != null && sledFPCJSONArray.length() > 0) {
            ...
            adaptorSelectedFpc = new AdaptorSelectedFPC(PsUpcomingEventDetailActivity.this, sledFPCJSONArray, actionType, PsUpcomingEventDetailActivity.this);
    ...
    private void setSelctFRgroup() {
        ...
        if (sledFRJSONArray != null && sledFRJSONArray.length() > 0) {
            ...
            adaptorSelectedFR = new AdaptorSelectedFR(PsUpcomingEventDetailActivity.this, sledFRJSONArray, actionType, PsUpcomingEventDetailActivity.this);
            ...
            if (!sledPomParticipants.equalsIgnoreCase("kS_FACILITATOR_ARRAY")) {
                ...
                if (sledPOMemberJSONArray.length() > 0) {
                    ...
                    if (sledPOMemberJSONArray.length() > 0) {
                        ...
                        adaptorSelectedPOMember = new AdaptorSelectedPOMember(PsUpcomingEventDetailActivity.this, sledPOMemberJSONArray, actionType, PsUpcomingEventDetailActivity.this);
        ...
        try {
            if (!sledOthParticipants.equalsIgnoreCase("kS_OTH_PARTICIPANTS_ARRAY")) {
                ...
                if (sledOthParticipantJSONArray.length() > 0) {
                    ...
                    adaptorSelectedOthParticipant = new AdaptorSelectedOthParticipants(PsUpcomingEventDetailActivity.this, sledOthParticipantJSONArray, actionType, PsUpcomingEventDetailActivity.this);
        ...
        try {
            ...
            if (!sledCoCoord.equalsIgnoreCase("kS_CO_COORDINATOR")) {
                ...
                if (sledCoCoordJSONArray.length() > 0) {
                    ...
                    adaptorSelectedCoCoord = new AdaptorSelectedCoCoord(PsUpcomingEventDetailActivity.this, sledCoCoordJSONArray, actionType, PsUpcomingEventDetailActivity.this);
        ...
        try {
            if (!sledCoordinator.equalsIgnoreCase("kS_COORDINATOR")) {
                ...
                if (sledCordJSONArray.length() > 0) {
                    ...
                    adaptorSelectedCoordinator = new AdaptorSelectedCoordinator(PsUpcomingEventDetailActivity.this, sledCordJSONArray, actionType, PsUpcomingEventDetailActivity.this);
    ...
    private void defaultConfiguration() {
        ...
        sledVCRMCMoreTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PsUpcomingEventDetailActivity.this, ParticipantGPListActivity.class);
        ...
        sledshgMoreTView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sledSHGJSONArray = eDB.getShglist();
                Intent intent = new Intent(PsUpcomingEventDetailActivity.this, ParticipantsListActivity.class);
        ...
        sledPOMMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledPomParticipants = AppSettings.getInstance().getValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, ApConstants.kS_FACILITATOR_ARRAY);
                if (!sledPomParticipants.equalsIgnoreCase("kS_FACILITATOR_ARRAY")) {
                    try {
                        sledPOMemberJSONArray = new JSONArray(sledPomParticipants);
                        // sledPOMemberJSONArray = eDB.getSledPOMemberList();
        ...
        selectCaResourceMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledResourceParticipants = AppSettings.getInstance().getValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_CA_RES_PERSON_ARRAY, ApConstants.kS_CA_RES_PERSON_ARRAY);
        ...
        sledOtherMoreTView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String sledOthParticipants = AppSettings.getInstance().getValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, ApConstants.kS_OTH_PARTICIPANTS_ARRAY);
    ...
    private void getScheduledEventBySchId(String Sch_id) {
        ...
        assert center != null;
        Log.d("shjgsdhgfshjdfg", level + center);

        if (level.equalsIgnoreCase("District") && center.equalsIgnoreCase("Subdivision")) {
            level = center;
        }
    ...
    private void clearInputFields() {
        ...
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_GP_ARRAY, ApConstants.kS_GP_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FARMER_ARRAY, ApConstants.kS_FARMER_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, ApConstants.kS_FACILITATOR_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_CA_RES_PERSON_ARRAY, ApConstants.kS_CA_RES_PERSON_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, ApConstants.kS_OTH_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_RES_PERSON, ApConstants.kS_RES_PERSON);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_COORDINATOR, ApConstants.kS_COORDINATOR);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_CO_COORDINATOR, ApConstants.kS_CO_COORDINATOR);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_EVENT_S_DATE, ApConstants.kS_EVENT_S_DATE);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_EVENT_E_DATE, ApConstants.kS_EVENT_E_DATE);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_SHG_PARTICIPANTS_ARRAY, ApConstants.kS_SHG_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FPC_PARTICIPANTS_ARRAY, ApConstants.kS_FPC_PARTICIPANTS_ARRAY);
        AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_farm_PARTICIPANTS_ARRAY, ApConstants.kS_farm_PARTICIPANTS_ARRAY);
        eDB.deleteAllData();
    }
        ...
        try {
            ...
            if (i == 1) {
                ...
                if (sledGPJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_GP_ARRAY, sledGPJSONArray.toString());
                    sledGPId = AppUtility.getInstance().componentSeparatedByCommaJSONArray(sledGPJSONArray, "gp_id");
                ...
                if (sledFarmerJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FARMER_ARRAY, sledFarmerJSONArray.toString());
                ...
                if (sledCoCoordJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_CO_COORDINATOR, sledCoCoordJSONArray.toString());
                ...
                if (sledCordJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_COORDINATOR, sledCordJSONArray.toString());
                ...
                if (sledPOMemberJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_FACILITATOR_ARRAY, sledPOMemberJSONArray.toString());
                ...
                if (sledOthParticipantJSONArray != null) {
                    ...
                    AppSettings.getInstance().setValue(PsUpcomingEventDetailActivity.this, ApConstants.kS_OTH_PARTICIPANTS_ARRAY, sledOthParticipantJSONArray.toString());
