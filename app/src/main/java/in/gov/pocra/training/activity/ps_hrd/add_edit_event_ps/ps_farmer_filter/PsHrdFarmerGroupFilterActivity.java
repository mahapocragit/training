...
import in.gov.pocra.training.activity.ca.add_edit_event_ca.ca_farmer_filter.CaFRFarmerGroupListActivity;
...
public class PsHrdFarmerGroupFilterActivity extends AppCompatActivity implements OnMultiRecyclerItemClickListener, AlertListCallbackEventListener, ApiCallbackCode, ApiJSONObjCallback {
    ...
    private void initialization() {
        ...
        nextButton.setText("Click for Farmer Group List");
    }
    ...
    private void defaultConfiguration() {
        ...
        subDivisionLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFarmerGroupFilterActivity.this)) {

                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PsHrdFarmerGroupFilterActivity.this, PsHrdFarmerGroupFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !districtId.equalsIgnoreCase("")) {
                            getSubDivisionList(districtId);
                        } else {
                            UIToastMessage.show(PsHrdFarmerGroupFilterActivity.this, "Please select district");
                        }
                    }

                } else {
                    UIToastMessage.show(PsHrdFarmerGroupFilterActivity.this, "No internet connection");
                }
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFarmerGroupFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PsHrdFarmerGroupFilterActivity.this, PsHrdFarmerGroupFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
                            UIToastMessage.show(PsHrdFarmerGroupFilterActivity.this, "Please select Sub-Division");
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PsHrdFarmerGroupFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", PsHrdFarmerGroupFilterActivity.this, PsHrdFarmerGroupFilterActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
                            UIToastMessage.show(PsHrdFarmerGroupFilterActivity.this, "Please select Taluka");
                        }
                    }
