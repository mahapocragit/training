...
public class AdaptorSubDivList extends RecyclerView.Adapter<AdaptorSubDivList.ViewHolder> {
    ...
    public AdaptorSubDivList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSubDivList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_gp, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSubDivList.ViewHolder viewHolder, int i) {
