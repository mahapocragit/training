...
public class AdaptorSelectedSGF extends RecyclerView.Adapter<AdaptorSelectedSGF.ViewHolder> {
    ...
    public AdaptorSelectedSGF(Context context, JSONArray jsonArray, String actType, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorSelectedSGF.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_selected, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AdaptorSelectedSGF.ViewHolder viewHolder, int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void onBind(final JSONObject jsonObject, final int position, OnMultiRecyclerItemClickListener listener) {
            ...
            try {
                ...
                final String villageId = jsonObject.getString("village_census_code");
                final String villageName = jsonObject.getString("chief_promoter_president");
