        ...
        if (userLaval.equalsIgnoreCase("District")){
            ...
            if (!loginData.equalsIgnoreCase("kLOGIN_DATA")){
                try {
                    ...
                    districtTView.setText(districtName);
                ...
                if (ApUtil.checkInternetConnection(PoCRAFieldStaffFilterActivity.this)) {
                    ...
                    if (!userLaval.equalsIgnoreCase("District")){
                        ...
                        if (districtJsonArray != null) {
                            ApUtil.showCustomListPicker(districtTView, districtJsonArray, "Select District", "name", "id", PoCRAFieldStaffFilterActivity.this, PoCRAFieldStaffFilterActivity.this);
                        } else {
                            if (centerName.equalsIgnoreCase("Subdivision")) {
                                getDistrictList();
                            } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PoCRAFieldStaffFilterActivity.this)) {
                    ...
                    if (subDivisionJsonArray != null) {
                        ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "name", "id", PoCRAFieldStaffFilterActivity.this, PoCRAFieldStaffFilterActivity.this);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PoCRAFieldStaffFilterActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", PoCRAFieldStaffFilterActivity.this, PoCRAFieldStaffFilterActivity.this);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PoCRAFieldStaffFilterActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "id", PoCRAFieldStaffFilterActivity.this, PoCRAFieldStaffFilterActivity.this);
                    } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(PoCRAFieldStaffFilterActivity.this)) {
                    ...
                    if (roleJsonArray != null) {
                        ApUtil.showCustomListPicker(roleTView, roleJsonArray, "Select Roles/Posts/Positions ", "name", "id", PoCRAFieldStaffFilterActivity.this, PoCRAFieldStaffFilterActivity.this);
                    } else {
   ...
   /* private void getVillageList(String talukaId) {
    ...
    public void didSelectAlertViewListItem(TextView textView, String s) {
        ...
        if (textView == roleTView) {
            ...
            if (pRoleId.equalsIgnoreCase("28") || pRoleId.equalsIgnoreCase("26") || pRoleId.equalsIgnoreCase("11")){
