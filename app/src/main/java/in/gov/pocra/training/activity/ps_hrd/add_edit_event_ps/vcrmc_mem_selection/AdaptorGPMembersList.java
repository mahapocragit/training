...
public class AdaptorGPMembersList extends RecyclerView.Adapter<AdaptorGPMembersList.ViewHolder> {
    ...
    public AdaptorGPMembersList(Context context, JSONArray jsonArray, OnMultiRecyclerItemClickListener listener) {
    ...
    @NonNull
    @Override
    public AdaptorGPMembersList.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final AdaptorGPMembersList.ViewHolder viewHolder, int i) {
