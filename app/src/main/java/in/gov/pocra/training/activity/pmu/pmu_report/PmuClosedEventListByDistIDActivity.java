...
import in.gov.pocra.training.activity.ps_hrd.ps_report.AdaptorPsClosedEvent;
...
public class PmuClosedEventListByDistIDActivity extends AppCompatActivity implements ApiCallbackCode {
    ...
    private AdaptorPmuClosedEvent adaptorPmuClosedEvent;
    ...
    private void initialization() {
        ...
        if (eventType.equalsIgnoreCase("kS_ALL_EVENT")){
            ...
            if (level.equalsIgnoreCase("Subdivision")) {
                getClosedEventListBySubDivId(level, distId, subDivId, "");
            } else {
                getClosedEventListByDistId(level, distId, "");
            }
        ...
        filterDateIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    // For month picker
//                    MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(PmuClosedEventListByDistIDActivity.this, new MonthPickerDialog.OnDateSetListener() {
//                        @Override
...
//                                String subDivId = getIntent().getStringExtra("subDivId");
//                                if (level.equalsIgnoreCase("Subdivision")) {
//                                    getClosedEventListBySubDivId(level, distId, subDivId, selectedYear + "-" + (selectedMonth + 1));
//                                } else {
//                                    getClosedEventListByDistId(level, distId, selectedYear + "-" + (selectedMonth + 1));
//                                }
//                            }
//                        }
...
//                            .show();
        ...
        searchEText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                PmuClosedEventListByDistIDActivity.this.adaptorPmuClosedEvent.filter(s.toString());
            }
        });
    ...
    private void getClosedEventList(String filterDate) {
        ...
        DebugLog.getInstance().d("get_pmu_Closed_Event_List_param=" + responseCall.request().toString());
        DebugLog.getInstance().d("get_pmu_Closed_Event_List_param=" + AppUtility.getInstance().bodyToString(responseCall.request()));

        api.postRequest(responseCall, this, 1);
    }


    private void getClosedEventListByDistId(String level, String distId, String filterDate) {
        ...
        Retrofit retrofit = api.getRetrofitInstance();
        APIRequest apiRequest = retrofit.create(APIRequest.class);
        Call<JsonObject> responseCall = apiRequest.getPMUDistWiseClosedEventListRequest(requestBody);
        api.postRequest(responseCall, this, 2);

        DebugLog.getInstance().d("get_closed_Scheduled_by_dist_param=" + responseCall.request().toString());
        DebugLog.getInstance().d("get_closed_Scheduled_by_dist_param=" + AppUtility.getInstance().bodyToString(responseCall.request()));

    }


    private void getClosedEventListBySubDivId(String level, String distId, String subDivId, String filterDate) {
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("user_id", userID);
            jsonObject.put("role_id", roleId);
            ...
            if (jsonObject != null) {
                ...
                if (i == 1) {
                    ...
                    if (responseModel.isStatus()) {
                        JSONArray cEventListByDidtJSONArray = jsonObject.getJSONArray("data");
                        adaptorPmuClosedEvent = new AdaptorPmuClosedEvent(this, cEventListByDidtJSONArray, level);
                        psClosedEventRView.setAdapter(adaptorPmuClosedEvent);
                    } else {
                        AdaptorPsClosedEvent adaptorPsClosedEvent = new AdaptorPsClosedEvent(this,new JSONArray(),level);
