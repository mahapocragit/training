        ...
        subDivisionLLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (subDivisionJsonArray != null) {
                    ApUtil.showCustomListPicker(subDivisionTView, subDivisionJsonArray, "Select Sub-division", "subdivision_name", "subdivision_id", SHGgrFarmerCaActivity.this, SHGgrFarmerCaActivity.this);
                } else {
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(SHGgrFarmerCaActivity.this)) {
                    ...
                    if (talukaJSONArray != null) {
                        ApUtil.showCustomListPicker(talukaTView, talukaJSONArray, "Select Taluka", "name", "id", SHGgrFarmerCaActivity.this, SHGgrFarmerCaActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !subDivisionId.equalsIgnoreCase("")) {
                            getTalukaList(subDivisionId);
                        } else {
//                            UIToastMessage.show(SHGgrFarmerCaActivity.this, "Please select Sub-Division");
                            Toast.makeText(getBaseContext(), "Please select Sub-Division", Toast.LENGTH_SHORT).show();
                        }
                    }

                } else {
//                    UIToastMessage.show(SHGgrFarmerCaActivity.this, "No internet connection");
            ...
            public void onClick(View v) {
                ...
                if (ApUtil.checkInternetConnection(SHGgrFarmerCaActivity.this)) {
                    ...
                    if (villageJSONArray != null) {
                        ApUtil.showCustomListPicker(villageTView, villageJSONArray, "Select Village", "name", "code", SHGgrFarmerCaActivity.this, SHGgrFarmerCaActivity.this);
                    } else {
                        if (centerName.equalsIgnoreCase("Subdivision") && !talukaId.equalsIgnoreCase("")) {
                            getVillageList(talukaId);
                        } else {
//                            UIToastMessage.show(SHGgrFarmerCaActivity.this, "Please select Taluka");
