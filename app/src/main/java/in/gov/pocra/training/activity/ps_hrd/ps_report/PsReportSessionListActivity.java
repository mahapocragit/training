...
public class PsReportSessionListActivity extends AppCompatActivity  implements ApiCallbackCode, OnMultiRecyclerItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ps_report_session_list);
    ...
    private void initialization() {
        ...
        sessionRView = (RecyclerView)findViewById(R.id.PsReportsessionRView);
    ...
    private void defaultConfiguration() {
        ...
        addSessionIView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PsReportSessionListActivity.this, AddSessionActivity.class);
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            RequestBody requestBody = AppUtility.getInstance().getRequestBody(param.toString());
                            AppinventorApi api = new AppinventorApi(PsReportSessionListActivity.this, APIServices.BASE_URL, "", ApConstants.kMSG, true);
                            Retrofit retrofit = api.getRetrofitInstance();
                            APIRequest apiRequest = retrofit.create(APIRequest.class);
                            ...
                            api.postRequest(responseCall, PsReportSessionListActivity.this, 2);
                ...
                if (i == 1) {
                    ...
                    if (responseModel.isStatus()) {
                        ...
                        if (dataArray.length()>0){
                            AdaptorPsReportSessionList adaptorPsReportSessionList = new AdaptorPsReportSessionList(PsReportSessionListActivity.this,dataArray,this);
                            sessionRView.setAdapter(adaptorPsReportSessionList);
                        }else {
                            AdaptorPsReportSessionList adaptorPsReportSessionList = new AdaptorPsReportSessionList(this,new JSONArray(),this);
                            sessionRView.setAdapter(adaptorPsReportSessionList);
                        }
