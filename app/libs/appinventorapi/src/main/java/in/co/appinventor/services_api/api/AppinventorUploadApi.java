...
/* renamed from: in.co.appinventor.services_api.api.AppinventorUploadApi */
public class AppinventorUploadApi implements DialogInterface.OnCancelListener {
    ...
    public AppinventorUploadApi(Context mContext2, String authToken2, boolean showProgressDialog, String progressMessage, boolean isCancellable) {
            ...
            if (!Utility.checkConnection(this.mContext)) {
                ...
                client.get(mURL, new JsonHttpResponseHandler() {
                    public void onSuccess(int statusCode, Header[] headers, JSONObject responseString) {
                        ...
                        if (AppinventorUploadApi.this.mProgressDialog != null && AppinventorUploadApi.this.mProgressDialog.isShowing()) {
                            AppinventorUploadApi.this.mProgressDialog.dismiss();
                        }
                    }
